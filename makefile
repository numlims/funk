...
docdir = ~/numlims.github.io/funk  # e.g. ~/mydoc.github.io/myprogram
...
build:
	make
	#pyright "${name}" # ruff apparently doesn't find 'variable possibly unbound' errors, see https://github.com/astral-sh/ruff/issues/2493#issuecomment-1414424880
